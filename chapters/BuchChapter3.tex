...
\begin{proof}
    ...
    \begin{align*}
        ...
        &=\lr{\frac{2}{np}\sum_{i,j=1}^{p}x_{ij}x_{ij}^H+\hat{x}_{ij}\hat{x}_{ij}^H}\lr{\frac{1}{np}\sum_{i,j=1}^{p}(x_{ij}-\hat{x}_{ij})(x_{ij}-\hat{x}_{ij})^H} \\
        &=\lr{\frac{2}{np}\sum_{i,j=1}^{p}|x_{ij}|^2+|\hat{x}_{ij}|^2}\lr{\frac{1}{np}\sum_{i,j=1}^{p}|x_{ij}-\hat{x}_{ij}|^2} \\
        &\leq \lr{\frac{4}{np}\sum_{i,j=1}^{p}|x_{ij}|^2}\lr{\frac{1}{np}\sum_{i,j=1}^{p}|x_{ij}|^2\mathbf{1}(|x_{ij}| > C)} \\
