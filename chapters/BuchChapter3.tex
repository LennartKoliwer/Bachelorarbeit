...
\begin{align}
    \beta_k=\beta_k\left(y,\sigma^2\right)=\int_{a}^{b}x^kp_y(x)\diff x \label{eq:momente}
\end{align} 
...
\begin{proof}
    ...
    \begin{align*}
        \beta_k &= \frac{1}{2\pi y}\sum_{l=0}^{\left\lfloor\frac{k-1}{2}\right\rfloor}\binom{k-1}{2l}(1+y)^{k-1-2l} (4y)^{l+1} \int_{-1}^{1}w^{l}\sqrt{1-w}\frac{1}{2\sqrt{w}}\diff w \\
        &= \frac{1}{2\pi y}\sum_{l=0}^{\left\lfloor\frac{k-1}{2}\right\rfloor}\binom{k-1}{2l}(1+y)^{k-1-2l} (4y)^{l+1} \frac12\int_{-1}^{1}w^{l-\frac12}\sqrt{1-w}\diff w
        \intertext{erhalten wir durch Vereinfachen dank eines geraden Integranten}
        \beta_k &= \frac{1}{2\pi y}\sum_{l=0}^{\left\lfloor\frac{k-1}{2}\right\rfloor}\binom{k-1}{2l}(1+y)^{k-1-2l} (4y)^{l+1} \int_{0}^{1}w^{l-\frac12}\sqrt{1-w}\diff w
    \end{align*}
    ein Integral, dass wir mittels Eulerschen Betafunktion \textcolor{red}{Quelle!} lösen können.
    ...
    Hier lassen sich diverse variablen kürzen, sodass wir 
    ...
    \end{align*}
    \textcolor{red}{summen untergrenze noch auf null setzen argumentieren} In dieser Form lässt sich die Vandermonde Identität \textcolor{red}{Quelle!} 
    \begin{align*}
        \sum_{"o=0}^{"u}\binom{n}{"o}\binom{m}{"u-"o}=\binom{n+m}{"u}
    \end{align*}
    anwenden. Damit erhalten wir dann
    \begin{align*}
        \beta_k &= \sum_{r=0}^{k-1} \frac1k\binom{k}{r}\binom{k}{r+1} y^{r}\\
