...
\begin{remark}
	...
	entsprechen.
\end{remark}
Der Beweis des Satzes \ref{theo:svd} folgt etwas später, da dafür noch zwei Lemmata benötigt werden.

\begin{definition}
	Die Diagonalelemente von $\hat{\Sigma}$ aus Satz \ref{theo:svd}, wobei $\sigma_i=\sqrt{\lambda_i}$ sind die Wurzeln der Eigenwerte von \(X^\top X\) und werden als Singulärwerte bezeichnet.
\end{definition}
