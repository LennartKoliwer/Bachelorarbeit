...
\begin{theorem}[Starkes gesetz der großen Zahlen]\label{theo:StarkeGroßeZahlen}\cite[139]{Stochastik}
...
\begin{definition}[Lévy-Metrik]\label{def:lévy}\cite[164]{Stochastik}
